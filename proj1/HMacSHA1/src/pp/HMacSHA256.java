...
/**
 * SHA256 Protection Plugin
 *
 * @author Simão Paulo Rato Alves Reis
 * @author Rafael Saraiva Figueiredo
 * @version 1.0
 */
public class HMacSHA256 implements IntegrityPP {
    ...
    @Override
    public byte[] sign(byte[] msg, byte[] key) throws ProtectionPluginException {
